...
/datum/devotion/divine/noc
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/noc,
...
/datum/devotion/divine/dendor
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/dendor,
...
/datum/devotion/divine/abyssor
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/abyssor, /datum/action/cooldown/spell/undirected/conjure_item/summon_leech),
...
/datum/devotion/divine/necra
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/necra, /datum/action/cooldown/spell/avert),
...
/datum/devotion/divine/ravox
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/ravox,
...
/datum/devotion/divine/xylix
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/xylix,
...
/datum/devotion/divine/pestra
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/pestra, /datum/action/cooldown/spell/undirected/conjure_item/summon_leech/pestra),
...
/datum/devotion/divine/malum
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/malum,
...
/datum/devotion/divine/eora
	miracles = list(
		CLERIC_T0 = /datum/action/cooldown/spell/healing/eora,
...
/datum/devotion/inhumen/zizo
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/profane/zizo, /datum/action/cooldown/spell/undirected/touch/orison, /datum/action/cooldown/spell/aoe/snuff),
		CLERIC_T1 = /datum/action/cooldown/spell/projectile/profane,
		CLERIC_T2 = list(/datum/action/cooldown/spell/healing/greater/profane, /datum/action/cooldown/spell/conjure/raise_lesser_undead),
...
/datum/devotion/inhumen/matthios
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/profane/matthios, /datum/action/cooldown/spell/appraise/holy),
...
/datum/devotion/inhumen/baotha
	miracles = list(
		CLERIC_T0 = list(/datum/action/cooldown/spell/healing/profane/baotha, /datum/action/cooldown/spell/find_flaw),
